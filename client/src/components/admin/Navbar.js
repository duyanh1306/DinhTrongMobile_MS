  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/70 backdrop-blur-md border-b border-gray-100 px-6 py-3 shadow-[0_4px_30px_rgba(0,0,0,0.03)] flex items-center justify-between transition-all duration-300">
      ...
      <div className="flex items-center gap-6">
        <Link to="/profile" className="flex items-center gap-3 bg-gray-50/50 py-1.5 pl-1.5 pr-4 rounded-full border border-gray-100 shadow-sm cursor-pointer hover:shadow-md hover:bg-white transition-all duration-300">

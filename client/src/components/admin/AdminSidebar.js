...
export default function AdminSidebar() {
  ...
  const items = [
    ...
    link: "/admin/repair_history",
},
    {
      icon: <FileText size={20} />,
      text: "Lịch sử mua hàng",
      link: "/admin/purchase_history",
    },
    {
      icon: <FileText size={20} />,
      text: "Lịch sử bán hàng",
      link: "/admin/sales_history",
    },
    {
    icon: <ArrowRightLeft size={20} />,
    text: "Lịch sử giao dịch kho",
    link: "/admin/inventory_transactions",
},
{
    icon: <Truck size={20} />,
    text: "Yêu cầu chuyển kho",
    link: "/admin/transfer_requests",
},
  ];

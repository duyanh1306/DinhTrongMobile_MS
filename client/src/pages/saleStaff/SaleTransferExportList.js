    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-orange-100 rounded-xl"><Truck className="text-orange-600" size={28} /></div>
                <div>
            ...
            {loading ? (
                <div className="py-20 text-center flex justify-center"><div className="animate-spin rounded-full h-10 w-10 border-4 border-orange-600 border-t-transparent"></div></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredRequests.map(req => {
                        ...
                        return (
                            <div key={req._id} className="bg-white p-5 rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className="bg-orange-100 text-orange-700 font-bold px-3 py-1 rounded-full text-xs flex items-center gap-1">
                                ...
                                <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 mb-4 flex gap-4 text-sm font-medium text-gray-700">
                                    <div>Linh kiện: <span className="text-orange-600 text-lg">{totalItems}</span></div>
                                    <div>Điện thoại: <span className="text-orange-600 text-lg">{totalPhones}</span></div>
                                </div>

                                <button onClick={() => navigate(`/sale/transfer-export/${req._id}`)} className="w-full py-2.5 bg-orange-600 text-white font-bold rounded-lg hover:bg-orange-700 transition flex items-center justify-center gap-2">

  ...
  const fetchOrders = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // CHỈ LẤY ĐƠN HÀNG PURCHASE
        const purchaseOrders = data.filter(order => order.orderType === "PURCHASE");
        setOrders(purchaseOrders);
      }
    } catch (error) {
      toast.error("Lỗi khi tải lịch sử mua hàng: " + error.message);
    }
  };
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
            <thead>
              <tr className="bg-gray-100 border-y border-gray-200">
                ...
                <th className="p-3 font-semibold text-gray-700">Đối tác / Khách hàng</th>
          ...
          <div className="bg-white rounded-lg w-full max-w-4xl relative shadow-xl max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 bg-gray-50 p-4 rounded-lg border border-gray-100">
                <div>
                  <h4 className="font-semibold text-gray-700 mb-2 border-b pb-1">Thông tin đối tác / khách hàng</h4>
                ...
                <div>
                  ...
                  <p className="text-sm mb-1">
                    <span className="text-gray-500">Nhân viên tạo:</span> <span className="font-medium">{selectedOrder.createdBy?.fullName || "N/A"}</span>
                  </p>
                  <p className="text-sm mb-1">

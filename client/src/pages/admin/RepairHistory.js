  ...
  const fetchOrderDetails = async (orderId) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error("Không thể tải chi tiết đơn sửa chữa");
      }
    } catch (error) {
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 min-h-[600px] flex flex-col">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-md bg-white focus:ring-2 focus:ring-orange-500 outline-none"
          >
              ...
              {currentOrders.map((order) => (
                <tr key={order._id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="p-3 text-gray-600">
                    {formatDate(order.repairOrderDate)}
                  </td>
                  <td className="p-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-4xl relative shadow-xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white rounded-t-lg z-10">
              <div>
                ...
                <p className="text-sm text-gray-500 flex items-center gap-2 mt-1">
                  <Calendar size={14} /> {formatDate(selectedOrder.repairOrderDate)}
                </p>
              </div>
            ...
            <div className="p-6 overflow-y-auto">
              ...
              <h4 className="font-bold text-gray-800 mb-3">Chi tiết dịch vụ / linh kiện ({orderDetails.length})</h4>
              {isLoadingDetails ? (
